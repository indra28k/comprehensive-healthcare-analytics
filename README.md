...
Maintained by: Indra Kumar Siripurapu
Email: indra.siripurapu22@gmail.com

## About the Developer
Indra Kumar Siripurapu is a Senior Data Analyst with over 8 years of experience in healthcare and pharmaceutical environments. He specializes in data validation, reconciliation, and compliance-focused reporting. With a strong background in SQL, Power BI, and SSRS, Indra focuses on transforming large datasets from enterprise systems into accurate, audit-ready outputs to support executive decision-making and regulated business processes.